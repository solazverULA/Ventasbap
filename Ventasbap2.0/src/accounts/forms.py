...
class UserAdminCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('full_name', 'email', 'city', 'ci')  # 'full_name',)
...
class UserAdminChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('full_name', 'email', 'city', 'ci', 'sex', 'age', 'cellphone', 'password', 'active', 'admin')
...
class RegisterForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('full_name', 'email', 'city', 'ci', 'sex', 'age', 'cellphone')  # 'full_name',)
